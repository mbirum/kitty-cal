...
class HomeFrame(ttk.Frame):    
    ...
    def create_widgets(self):
        ...
        self.total_calories_label = ttk.Label(header_frame, 
            text=f"{date.today()}     💊 {self.master.calories_today['bova_taken']}/2     💧 {self.master.calories_today['drops_taken']}/4     🤢 {self.master.calories_today['nausea_taken']}/1    {self.master.get_total_calories()}/200 cal   ", 
